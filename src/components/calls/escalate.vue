...
<div class="container mx-auto" >
    <div class="row">
      ...
      <fieldset style="width: 180%; " >
                <h2 class="fs-title" id="step1" style="font-size: 18px" ><strong>Escalate</strong></h2>
                <h3 class="fs-subtitle" style="font-size: 18px;" >The issue is beyond you</h3>
  ...
  <input type="text" v-model="ticketbody.assignedtoNames" class="form-control form-control-lg" required style="font-size: 18px;" placeholder="Pulled from db automatically" disabled/>
              ...
              <div class="col-md-3 ps-5">
                ...
                <h6 class="mb-0" style="font-size: 20px;">Reason <span class="required" style="color: red;font-size: 15px;padding: 5px;" disabled>*</span></h6>
  
              </div>
              <div class="col-md-9 pe-5">
  
                <textarea class="form-control" v-model="this.ticketescalation"  rows="3" placeholder="Decsribe why the issue was escalated here ..." required style="font-size: 18px;"  ></textarea>
  
              </div>
            </div>
  
              <hr class="mx-n3" />
              <button class="btn btn-primary" @click.prevent="EscalateTicket()">Escalated</button>
      ...
      var userids= this.selectedoption;
          // var users= await this.GettingAllUsers();
           ...
           const formvalues={
            ticketid:idticket,
             userId:userids,
             escalation:this.ticketescalation,
             status:"Escalated" 
           }
           
           var resp= await this.EscalatingTickets(formvalues);
           if(resp.code=="200"){
            this.spinner=false;
