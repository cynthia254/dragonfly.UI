  ...
  <div class="container mx-auto" >
      <div class="row">
        ...
        <fieldset style="width: 180%; " >
                  <h2 class="fs-title" id="step1" style="font-size: 18px" ><strong>Close Ticket</strong></h2>
                  <h3 class="fs-subtitle" style="font-size: 18px;" >Hurray!Well Done</h3>
    ...
    <input type="text" v-model="ticketbody.assignedtoNames" class="form-control form-control-lg" required style="font-size: 18px;" placeholder="Pulled from db automatically" disabled/>
                ...
                <div class="col-md-9 pe-5">
                  ...
                  <textarea class="form-control" v-model="ticketbody.resolution" rows="3" placeholder="Decsribe how the issue was resolved here ..." required style="font-size: 18px;" disabled ></textarea>
                ...
                <button class="btn btn-primary" @click.prevent="CloseTicket()">Close Ticket</button>
        ...
        var userids= this.selectedoption;
            // var users= await this.GettingAllUsers();
             ...
             const formvalues={
              ticketid:idticket,
               userId:userids,
               TicketTitle:"Closed Ticket",
               status:"Closed" 
             }
             
             var resp= await this.ClosingTickets(formvalues);
             if(resp.code=="200"){
              this.spinner=false;
