<template>
  ...
  <div class="row">
    ...
    <fieldset style="width: 180%; " >
              <h2 class="fs-title" id="step1" style="font-size: 18px" ><strong>Resolve</strong></h2>
              <h3 class="fs-subtitle" style="font-size: 18px;" >The issue is resolved awaiting to be closed</h3>
...
<div class="col-md-3 ps-5">
  ...
  <h6 class="mb-0" style="font-size: 20px;">Assigned To<span class="required" style="color: red;font-size: 15px;padding: 5px;">*</span></h6>

</div>
<div class="col-md-9 pe-5">

<input type="text" v-model="ticketbody.assignedtoNames" class="form-control form-control-lg" required style="font-size: 18px;" placeholder="Pulled from db automatically" disabled/>
            ...
            <div class="col-md-3 ps-5">
              ...
              <h6 class="mb-0" style="font-size: 20px;">Resolution <span class="required" style="color: red;font-size: 15px;padding: 5px;">*</span></h6>

            </div>
            <div class="col-md-9 pe-5">

              <textarea class="form-control" v-model="this.ticketresolution" rows="3" placeholder="Decsribe how the issue was resolved here ..." required style="font-size: 18px;" ></textarea>

            </div>
          </div>

            <hr class="mx-n3" />
            <button class="btn btn-primary" @click.prevent="ResolveTicket()">Resolve</button>
    ...
    var userids= this.selectedoption;
        // var users= await this.GettingAllUsers();
         ...
         const formvalues={
          ticketid:idticket,
           userId:userids,
           resolution:this.ticketresolution,
           status:"Resolved" 
         }
         
         var resp= await this.ResolvingTickets(formvalues);
         if(resp.code=="200"){
          this.spinner=false;
