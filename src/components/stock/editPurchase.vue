...
export default {
  ...
  methods:{
    async gettingPurchasebyId() {
      var purchaseid=this.purchaseId;
      var response = await this.gettinPurchaseById(purchaseid);
      this.purchaseBody = response.body;
      console.log("response on purchase body: : ", this.purchaseBody);
