<template>
 ...
 export default {
   ...
   methods:{
     async gettingsupplierbyid() {
       var supplierid=this.supplierId;
       var response = await this.gwttingsupplierbyid(supplierid);
       this.supplierBody = response.body;
       console.log("response on supplier body: : ", this.supplierBody);
 ...
 formatDateAssigned(value) {
     ...
     async changepurchasestatus(){
       var body = {
         ...
         supplierName:this.supplierBody.supplierName,
         companyName:this.supplierBody.companyName,
         email:this.supplierBody.email,
         phoneNumber:this.supplierBody.phoneNumber,
       ...
       console.log("user id: ", body)
            var resp= await this.edititngSupplier(body);
            if(resp.isTrue == true){
   ...
   created(){
     this.supplierId = this.$route.params.supplierId;
         console.log("purchaseId :", this.supplierId);
     this.gettingsupplierbyid();
