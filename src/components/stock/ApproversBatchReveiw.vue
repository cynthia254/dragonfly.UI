      ...
      <div class="table-wrapper">
        ...
        <tr >
                ...
                <tbody>
                    ...
                    <th scope="row" style="text-align: center;vertical-align: middle;" >{{this.allinvoice.batchNumber}}</th>
                    <td style="text-transform: uppercase;" >{{ this.allinvoice.deliveryNumber }}</td>
                    <td >{{ getFormattedDate(this.allinvoice.deliveryDate) }}</td>
                    <td >{{ this.allinvoice.batchQuantity }}</td>
                    <td >{{ this.allinvoice.quantityDamaged }}</td>
                    <td>{{ this.allinvoice.categoryName }}</td>
                    <td>{{ this.allinvoice.meansOfDelivery }}</td>
                    <td >{{ this.allinvoice.airWayBillNumber }}</td>
                    <td style="color:green">{{ this.allinvoice.productStatus }}</td>
                    <td >{{ formatDate(this.allinvoice.dateCreated) }}</td>
...
// Assuming batchID is defined and contains the correct value
   ...
   console.log("response on batch  body:<<<<<<<<<<<<<<< : ", this.allinvoice);
   console.log("batch number:", this.allinvoice.batchNumber);
...
this.$router.push({
  path: "/batchreview" ,  
      ...
      async gettingformbyid() {
        var ID = this.id;
        const response = await this.getFormbyId(ID);
