                        ...
                        <div class="card">
                            <div class="card-body" style="border-style: none;">
                                <div class="d-flex flex-column align-items-center text-center" >
                                    <div class="mt-3">
                                        <h4 style="font-size: 30px;font-weight: bold;color: green;">{{this.batchbody.poNumber}}</h4>
                                        <p class="text-secondary mb-1" style="color: black;font-weight: bold;font-size: 20px;">{{this.batchbody.batchNumber}}</p>

                                    </div>
                                    <button class="movebtn movebtnsu"  style="margin-top: 20px;margin-left: 0px;width:30%;font-family: inter;font-size: 13px;" >
         <router-link to="/batchreview" style="color: black;">  Back</router-link></button
       >
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="top-status col-lg-4 ">
                                    <h5 style="color:red;font-weight: bold;">{{this.batchbody.deliveryNumber}}</h5>
                                    <ul>
                                        <li class="active">
                                            ...
                                            <span>{{this.batchbody.productStatus}}</span>
                                        </li>
                                       
                                    </ul>
                                </div>
                                <div class="col-lg-8" style="font-family: inter;">
                                  <h4 style="font-weight: bold;"><button class="movebtn movebtnsu"  style="margin-top: 20px;margin-left: 0px;width:20%;font-family: inter;font-size: 13px;" >
         <router-link to="" @click.prevent="addDeliveryNumber()" style="color: black;">  Back</router-link></button
       ></h4>
                                   
                                    <h4 style="font-weight: bold;">Delivery Date:    <span style="font-size: 19px;font-weight: lighter;">{{ getFormattedDate(this.batchbody.deliveryDate) }}</span></h4>
                                    <h4 style="font-weight: bold;">Means Of Delivery:    <span style="font-size: 19px;font-weight: lighter;">{{ this.batchbody.meansOfDelivery }}</span></h4>
                                    <h4 style="font-weight: bold;">AirWayBill Number:   <span style="font-size: 19px;font-weight: lighter;">{{ this.batchbody.airWayBillNumber }}</span></h4>
                                    <h4 style="font-weight: bold;">Date Created:  <span  style="font-size: 19px;font-weight: lighter;font-family:inter">{{ formatDate(this.batchbody.dateCreated) }}</span></h4>
                                </div>
                            </div>
                        ...
                        <div class="card mt-4">
                            <div class="card-body p-0 table-responsive table-bordered">
                                <h4 class="p-3 mb-0">Batch Details</h4>
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        <tr style="font-family: inter;font-size: 16px;font-weight: medium;color: gray;  ">
                                            ...
                                            <td><span class="badge badge-warning">{{this.batchbody.productStatus}}</span></td>
                                        </tr>
