...
>
  ...
  <router-link to="/purchaseordered"><button class="btn btn-flat " type="button" id="print" style="width: 100px;background-color: black;color: white;" >Back To List</button></router-link>
