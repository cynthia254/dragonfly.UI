<template >
  ...
  <div class="row" style="background: #F6F7F9">
    ...
    <div class="d-flex " style="background: #F6F7F9">
    <div class="col-md-12 col-lg-6" style="margin-left:100px">
      <div class="mb-3 card mt-5" style="background: #F6F7F9">
        <div class=" " style="background: #F6F7F9">
        ...
        <div class="">
          ...
          <h3 class="mt-3" style="margin-left: 40px;font-size: 20px;">Items At Re-Order Level</h3>
          <div class="">
            <div class="row">
              <div class="">
    ...
    <div class=" w-50 mt-5 text-center" style="margin-left: 50px;background: #F6F7F9">
        <Doughnut />
    </div>
    </div>
...
<script>
import Doughnut from "../bargraph/doughnut.vue";
